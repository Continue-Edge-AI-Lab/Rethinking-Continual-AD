...
has several types of anomalies) contains on average 17 images. We felt like moving 20% of the anomalies
...
class mvtec(Dataset):
    def __init__(self,
        ...
        self.task = task
        self.all_tasks = ['bottle', 'cable', 'capsule', 'carpet', 'grid', 'hazelnut',
    ...
    def __getitem__(self, idx):
        ...
        if anom_type == 'good':
            ...
            gt_filename = f'{self.path}/{task}/ground_truth/{anom_type}/{img_num}_mask.png'
